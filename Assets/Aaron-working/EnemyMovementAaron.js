...
function OnGUI() {
	...
	GUI.Box(Rect(cam.WorldToScreenPoint(transform.position).x - (renderer.bounds.size.x * 20), (Screen.height - cam.WorldToScreenPoint(transform.position).y) - (renderer.bounds.size.y * 30), health*20 + 5, 5), "");
